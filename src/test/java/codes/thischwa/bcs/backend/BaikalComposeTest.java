...
public class BaikalComposeTest extends AbstractBackendTest {
  ...
  static {
    try {
      dockerConfig = prepareDockerCompose("baikal", "baikal");
    } catch (IOException e) {
      throw new RuntimeException("Failed to prepare docker-compose for Baikal test", e);
    }
  }
  ...
  static void registerProperties(DynamicPropertyRegistry registry) {
    ...
    registry.add("dav.card-urls[0]", () -> BASE_URL + "dav.php/addressbooks/dev-user/default/");
