...
- `dav.delay-in-minutes`: This property determines the delay interval (in minutes) between retries in the event of network problems. The default setting is _1_.
- `dav.max-trails`: The maximum number of retries due to network errors. The default setting is _5_.
