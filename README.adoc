...
image:https://github.com/th-schwarz/BirthdayCalendarService/actions/workflows/maven.yml/badge.svg["GitHub CI Build Status",link="https://github.com/th-schwarz/BirthdayCalendarService/actions/workflows/maven.yml"]
image:https://img.shields.io/github/license/th-schwarz/BirthdayCalendarService["License badge for BirthdayCalendarService",link="https://github.com/th-schwarz/BirthdayCalendarService/blob/develop/LICENSE"]

Give it a try!
https://github.com/th-schwarz/BirthdayCalendarService/releases[image:https://img.shields.io/github/v/release/th-schwarz/BirthdayCalendarService?include_prereleases[GitHub
release (latest by date including pre-releases)]]         image:https://img.shields.io/github/downloads/th-schwarz/BirthdayCalendarService/total[GitHub Downloads (all assets, all releases)]
image:https://ghcr-badge.elias.eu.org/shield/th-schwarz/BirthdayCalendarService/bcg[]
...
* Docker support
* Java 17+ compatible
* Successful tested with SOGo, Baikal, Radicale +
see below "Backend Tests"

If you find a bug or certain features are missing, don't hesitate to file an issue on https://github.com/th-schwarz/BirthdayCalendarService/issues[Github].
...
All backend tests: image:https://github.com/th-schwarz/BirthdayCalendarService/actions/workflows/backend-tests.yml/badge.svg["GitHub CI All Backend Tests",link="https://github.com/th-schwarz/BirthdayCalendarService/actions/workflows/backend-tests.yml"]

Single backend tests:

* image:https://github.com/th-schwarz/BirthdayCalendarService/actions/workflows/backend-baikal.yml/badge.svg["GitHub CI Baikal Backend Tests",link="https://github.com/th-schwarz/BirthdayCalendarService/actions/workflows/backend-baikal.yml"]
* image:https://github.com/th-schwarz/BirthdayCalendarService/actions/workflows/backend-sogo.yml/badge.svg["GitHub CI Sogo Backend Tests",link="https://github.com/th-schwarz/BirthdayCalendarService/actions/workflows/backend-sogo.yml"]
* image:https://github.com/th-schwarz/BirthdayCalendarService/actions/workflows/backend-radicale.yml/badge.svg["GitHub CI Radicale Backend Tests",link="https://github.com/th-schwarz/BirthdayCalendarService/actions/workflows/backend-radicale.yml"]
...
Download the https://github.com/th-schwarz/BirthdayCalendarService/releases[last release jar].
