...
image:https://img.shields.io/github/license/th-schwarz/birthday-calendar-service[GitHub License]

image:https://sonarcloud.io/api/project_badges/measure?project=th-schwarz_birthday-calendar-service&metric=alert_status[Quality Gate Status,link=https://sonarcloud.io/summary/new_code?id=th-schwarz_birthday-calendar-service]
image:https://sonarcloud.io/api/project_badges/measure?project=th-schwarz_birthday-calendar-service&metric=security_rating[Security Rating,link=https://sonarcloud.io/summary/new_code?id=th-schwarz_birthday-calendar-service]
image:https://sonarcloud.io/api/project_badges/measure?project=th-schwarz_birthday-calendar-service&metric=coverage[Coverage,link=https://sonarcloud.io/summary/new_code?id=th-schwarz_birthday-calendar-service]
image:https://sonarcloud.io/api/project_badges/measure?project=th-schwarz_birthday-calendar-service&metric=ncloc[Lines of Code,link=https://sonarcloud.io/summary/new_code?id=th-schwarz_birthday-calendar-service]
image:https://sonarcloud.io/api/project_badges/measure?project=th-schwarz_birthday-calendar-service&metric=code_smells[Code Smells,link=https://sonarcloud.io/summary/new_code?id=th-schwarz_birthday-calendar-service]
