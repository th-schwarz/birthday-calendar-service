...
Images built from other branches are tagged with the branch name in lowercase, with `/` replaced by `-`, for example:
[source,bash]
----
ghcr.io/th-schwarz/bcg:feature-x
----
Branch `feature/x` is tagged as `feature-x`.
